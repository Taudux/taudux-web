/*
  ...
  misma forma que el registro que arma el servicio con la 0039/0040/0041 —los
  ...
  Las tres primeras estrenan habilidades, idiomas y empresa; el resto los
  deja vacíos o en null. Todos son opcionales (0041), ninguno entra en
  tienePerfil() y vacíos ocultan su celda ENTERA en el perfil: hace falta
  tener de los dos casos. La primera trae además el enlace de la empresa, que
  es lo que hace su nombre clicable.
...
const COLABORADORES_MUESTRA = [
  {
    ...
    empresa: "Taudux", empresa_enlace: "https://taudux.com",
  ...
  },
  {
    ...
    empresa: "Nube Verde", empresa_enlace: null,
  ...
  },
  {
    ...
    empresa: "Estudio Mena", empresa_enlace: null,
  ...
  },
  {
    ...
    habilidades: [], idiomas: [],
    empresa: null, empresa_enlace: null,
